...
class MainMenu(Screen):
    def __init__(self, name, screen, x, y, active, level_num, music_path):
        ...
        # self.button_options = Button(x=SCREEN_DIMENSIONS[0]//2, y=SCREEN_DIMENSIONS[1]//2+75, texto='OPCIONES', pantalla=pantalla, on_click=self.click_option, on_click_param='form_options')
        # self.button_rankings = Button(x=SCREEN_DIMENSIONS[0]//2, y=SCREEN_DIMENSIONS[1]//2+150, texto='RANKING', pantalla=pantalla, on_click=self.click_ranking, on_click_param='form_rankings')
        ...
        self.widget_list = [
            self.menu_ppal_title, self.button_start
