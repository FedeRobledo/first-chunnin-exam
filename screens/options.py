...
class Options(Screen):
    ...
    def __init__(self, name, screen, x, y, active, level_num, music_path):
        ...
        self.optiones_title = TextTitle(x=SCREEN_DIMENSIONS[0]//2, y=50, text='Examen Chunnin', screen=screen, font_size=60)
        self.optiones_subtitle = TextTitle(x=SCREEN_DIMENSIONS[0]//2, y=SCREEN_DIMENSIONS[1]//2-100, text='OPCIONES', screen=screen, font_size=40)
