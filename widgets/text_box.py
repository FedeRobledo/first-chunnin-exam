...
from modules.constants import GREEN_COLOR, KNIFE_SOUND

class TextBox(Widget):
    
    def __init__(self, x, y, text, screen, font_size=25, on_click=None, on_click_param=None):
        super().__init__(x, y, text, screen, font_size)
        self.font = pg.font.Font('assets/fonts/alagard.ttf', self.font_size)
